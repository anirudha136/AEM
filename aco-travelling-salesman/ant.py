...
# Creates an empty path matrix for movement between each and every city
...
def nextCity(cities_matrix, pheromoACOne_trail,visited_path):
...
# new pheromone for a particular edge
